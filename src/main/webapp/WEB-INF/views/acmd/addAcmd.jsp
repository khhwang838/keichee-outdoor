    	...
    	<div class="input-data">
    		...
    		<form id="add-acmd-form">
    			<div id="content-g-info">
    				...
    				<br>
    				<input name="acmdName" class="input-name" type="text" placeholder="Name of Accommodation">
    				<p	/>
    				...
    				<div class="mo-tooltip inline"></div>
    				<br>
    				<input name="acmdDesc" class="input-desc" type="text"  placeholder="Describe your accommodation for customers.">
    				<p />
    				...
    				<table>
    					...
    					<tr>
    						<td>
    							<input name="acmdEmail" class="input-email" type="text"  placeholder="E-mail Address">
    						</td>
    						<td>
    							<input name="acmdPhone" class="input-phone" type="text"  placeholder="Phone Number">
    						</td>
    					</tr>
    				</table>
    				<p />
    			...
    			<div id="content-l-settings">
    				...
    				<div>
    					...
    					<div class="input-type location-map">
    						...
    						<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBuThZWpfwiFsnXJjEtxqikxCnQJo0o6TI&callback=initMap"> </script>
    						<table>
    							<tr>
    								<td>Latitude</td>
    								<td>Longitude</td>
    				...
    				<div>
    					...
    					<input type="text" name="direction" placeholder="Provide guests with directions to your place, suggestions on transportation, and any other details that may help them arrive easily and on time.">
    				</div>
    						...
    						<div class="rs-item">
    							<table class="recommend-spots-tb w-100-p">
    								<tr>
    									...
    									<td>
    										<div class="rs-title">
    											Title <p/><input class="w-100-p" type="text" name="rsTitle" placeholder="Name of Tourist Spot near by your accommodation">
    										</div>
    									</td>
    								...
    								<tr>
    									<td>
    										<div class="rs-desc">
    											Description of Tourist Spot<p/><textarea class="w-100-p" type="text" name="rsDesc" placeholder="Provide quests with directions and descriptions of tourist spot that makes attractive to stay your accommodation"></textarea>
    										</div>
    									</td>
    								</tr>
    							</table>
    			...
    			<div id="content-acmd-details">
    				<div>
    					...
    					<input class="input-type" type="checkbox" name="acmd-type" value="auto-camping">Auto Camping
    					<input class="input-type" type="checkbox" name="acmd-type" value="caravan">Caravan
    					<input class="input-type" type="checkbox" name="acmd-type" value="easy-glamping">Easy Glamping
    					<input class="input-type" type="checkbox" name="acmd-type" value="lodge-villa">Lodge & Villa
    					<input class="input-type" type="checkbox" name="acmd-type" value="luxury-glamping">Luxury Glamping
    				</div>
    				...
    				<div>
    					...
    					<input class="input-type" type="checkbox" name="acmd-facility" value="bicycle-storage">Bicycle Storage
    					<input class="input-type" type="checkbox" name="acmd-facility" value="cafe">Cafe
    					<input class="input-type" type="checkbox" name="acmd-facility" value="handicapped">Handicapped
    					<input class="input-type" type="checkbox" name="acmd-facility" value="no-pet-allowed">No Pet Allowed
    					<input class="input-type" type="checkbox" name="acmd-facility" value="parking">Parking
    					<input class="input-type" type="checkbox" name="acmd-facility" value="picnic-table">Picnic Table
    					<input class="input-type" type="checkbox" name="acmd-facility" value="pool">Pool
    					<input class="input-type" type="checkbox" name="acmd-facility" value="shops">Shops
    					<input class="input-type" type="checkbox" name="acmd-facility" value="wifi">Wifi
    				</div>
    				<p/>
    				...
    				<div>
    					...
    					<input class="input-type" type="checkbox" name="acmd-theme" value="beach-front">Beach Front
    					<input class="input-type" type="checkbox" name="acmd-theme" value="countryside">Countryside
    					<input class="input-type" type="checkbox" name="acmd-theme" value="couple-friendly">Couple Friendly
    					<input class="input-type" type="checkbox" name="acmd-theme" value="event-party">Event & Party
    					<input class="input-type" type="checkbox" name="acmd-theme" value="family-friendly">Family Freindly
    					<input class="input-type" type="checkbox" name="acmd-theme" value="forest">Forest
    					<input class="input-type" type="checkbox" name="acmd-theme" value="hillside">Hillside
    					<input class="input-type" type="checkbox" name="acmd-theme" value="lake-view">Lake View
    					<input class="input-type" type="checkbox" name="acmd-theme" value="mountain">Mountain
    					<input class="input-type" type="checkbox" name="acmd-theme" value="pet-allowed">Pet Allowed
    					<input class="input-type" type="checkbox" name="acmd-theme" value="river-view">River View
    					<input class="input-type" type="checkbox" name="acmd-theme" value="stream-side">Streamside
    					<input class="input-type" type="checkbox" name="acmd-theme" value="valley">Valley
    				</div>
    				<p>
    			...
    			<div id="content-acmd-gallery">
    				...
    				<div>Upload the attractive features of your accommodation that guests might love.<div class="mo-tooltip inline"></div></div>
    					...
    					<div class="content-box">
    						...
    						<div class="eo-item">
    							...
    							<table>
    								...
    								<tr><td><input type="number" name="eoMaxItems0" placeholer="Input max number of the item that can be ordered"></td>
    									<td><input type="radio" name="eoPayment0" value="onsite"> On-site Payment Only  <input type="radio" name="eoPayment0" value="option"> Available in Extra Option</td></tr>
    								<tr>
    									<td colspan="2">
    			...
    			<div id="content-policy">
    				...
    				<div>
    					...
    					<input type="radio" name="confirm" value="instant">Instant Confirmation
    					<input type="radio" name="confirm" value="within">Confirmation within

    					<select id="confirm-within">
    				...
    				<div>
    					...
    					<input type="radio" name="booking-availability" value="today">Available Today
    					<input type="radio" name="booking-availability" value="within">Booking is available at least
